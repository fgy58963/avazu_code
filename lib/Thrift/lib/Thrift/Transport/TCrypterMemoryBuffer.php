...
class TCrypterMemoryBuffer extends TTransport {
  ...
  function commitWrite() {
    ...
    if ($write_buf_len > 0) {
      ...
      $this->write_buf_out_ = $buf;
      $this->write_buf_ = "";
    }
  }
  public function RetWriteData(){
    // log_message("ddd:".$this->write_buf_out_);
    return $this->write_buf_out_;
  }
