<?php
class AvazuCDNFileUploadClientAPI {
	...
	public static function outputUploadFrame($text, $foreColor, $bgColor) {
		$html = '<iframe id="banneruploadframe" ';
		$html .= 'width="100%" ';
		$html .= 'height="50" ';
		$html .= 'frameborder="no" ';
		$html .= 'border="0" ';
...
(function() {
	var frame = window.top.document.getElementById('banneruploadframe');
