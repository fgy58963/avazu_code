...
?>
<h2>
    <a href="javascript:;"onclick="history.go(-1);return false;" class="goback">返回</a>
    <a class="h2-tit h2-current" href="#"><?php echo $title?></a>
</h2>
...
<table class="layout">
    ...
    <tr>
        ...
        <td>
            ...
            <a href="javascript:;" class="sdc-form-button sdc-form-button-big" onclick="$('#scaffold-form').submit();">保存</a>
            <a href="javascript:;" class="sdc-form-button sdc-form-button-big" onclick="history.go(-1);return false;">返回</a>
        </td>
        <td>&nbsp;</td>
    </tr>
</table>
